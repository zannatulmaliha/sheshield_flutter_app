...
/// the app, generated in code so it always renders crisply offline with no
/// external asset or licensing dependency.
            ...
            return Stack(
              children: [
                _Blob(
                  ...
                  colors: [AppColors.primary.withValues(alpha: 0.14), Colors.transparent],
                ),
                _Blob(
                  top: size.height * 0.22 + math.cos(t * 0.8) * 22,
                  right: -size.width * 0.38 + math.sin(t * 0.8) * 18,
                  diameter: size.width * 0.95,
                  colors: [AppColors.secondary.withValues(alpha: 0.14), Colors.transparent],
                ),
                _Blob(
