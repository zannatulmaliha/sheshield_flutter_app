...
Future<void> showLevelUpCelebration(BuildContext context, {required int level, required String tierTitle}) {
  return Navigator.of(context).push(
    PageRouteBuilder(
      opaque: false,
      barrierColor: Colors.black87,
      pageBuilder: (_, _, _) => LevelUpOverlay(level: level, tierTitle: tierTitle),
    ),
  );
}
