...
abstract class $HelperStatusCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isActive, double radiusKm});
}
...
class _$HelperStatusImpl implements _HelperStatus {
  const _$HelperStatusImpl({this.isActive = false, this.radiusKm = 3.0});
  ...
  @override
  String toString() {
    return 'HelperStatus(isActive: $isActive, radiusKm: $radiusKm)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, isActive, radiusKm);
...
abstract class _HelperStatus implements HelperStatus {
  const factory _HelperStatus({final bool isActive, final double radiusKm}) =
      _$HelperStatusImpl;
